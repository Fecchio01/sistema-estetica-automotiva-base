...
test('linguagem visual compartilhada evita controles quadrados e campos nativos quebrados', () => {
  ...
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover,\.main-content \.dashboard-attention-item:hover\{animation:none!important;transition:none!important;transform:none!important;box-shadow:0 12px 26px rgba\(35,79,57,\.1\);background:#fff!important\}/)

...
test('linguagem visual compartilhada evita controles quadrados e campos nativos quebrados', () => {
  ...
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover::before\{transform:none;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)/)
  assert.match(styles, /\.main-content \.dashboard-attention-item:hover::before\{transform:none;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)/)
  assert.match(styles, /\.main-content \.dashboard-summary-service\{transition:box-shadow \.22s ease\}/)
  assert.match(styles, /\.main-content \.dashboard-summary-service:hover\{transform:none;box-shadow:0 12px 26px rgba\(35,79,57,\.1\);background:#fff\}/)
  ...
  assert.match(styles, /\.main-content \.dashboard-summary-service\{animation:none!important;transition:none!important;transform:none!important\}/)
  assert.match(styles, /\.main-content \.dashboard-summary-service:hover\{animation:none!important;transition:none!important;transform:none!important;box-shadow:none!important;background:#fff!important\}/)
  assert.match(styles, /\.main-content \.dashboard-paddock-row,\.main-content \.dashboard-attention-item\{animation:none!important;transition:transform \.22s ease;transform:none!important\}/)
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover,\.main-content \.dashboard-attention-item:hover\{animation:none!important;transition:transform \.22s ease;transform:scale\(1\.012\)!important;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)!important;background:#fff!important\}/)

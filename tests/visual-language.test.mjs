...
test('linguagem visual compartilhada evita controles quadrados e campos nativos quebrados', () => {
  ...
  assert.match(styles, /\.main-content \.dashboard-paddock-row,\.main-content \.dashboard-attention-item,\.main-content \.dashboard-summary-service\{animation:none!important;transition:none!important;transform:none!important\}/)
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover,\.main-content \.dashboard-attention-item:hover,\.main-content \.dashboard-summary-service:hover\{animation:none!important;transition:none!important;transform:none!important;box-shadow:none!important;background:#fff!important\}/)

...
test('linguagem visual compartilhada evita controles quadrados e campos nativos quebrados', () => {
  ...
  assert.match(styles, /\.main-content \.dashboard-paddock-row,\.main-content \.dashboard-attention-item,\.main-content \.dashboard-summary-service,\.main-content \.dashboard-summary-metric\{animation:none!important;transition:transform \.22s cubic-bezier\(\.16,1,\.3,1\)!important;transform:none!important;box-shadow:none!important;background:inherit!important\}/)
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover,\.main-content \.dashboard-attention-item:hover,\.main-content \.dashboard-summary-service:hover,\.main-content \.dashboard-summary-metric:hover\{animation:none!important;transition:transform \.22s cubic-bezier\(\.16,1,\.3,1\)!important;transform:translateY\(-3px\)!important;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)!important;background:inherit!important;border-color:inherit!important\}/)

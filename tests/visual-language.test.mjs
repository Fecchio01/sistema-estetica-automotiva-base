...
test('linguagem visual compartilhada evita controles quadrados e campos nativos quebrados', () => {
  ...
  assert.match(styles, /\.main-content \.dashboard-paddock-row:hover\{transform:translateY\(-3px\);background:#fff;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)/)
  assert.match(styles, /\.main-content \.dashboard-attention-item:hover\{transform:translateY\(-3px\);background:#fff;box-shadow:0 12px 26px rgba\(35,79,57,\.1\)/)
  ...
  assert.match(styles, /\.main-content \.dashboard-summary-service\{transition:transform \.22s ease,box-shadow \.22s ease,background \.22s ease\}/)
  assert.match(styles, /\.main-content \.dashboard-summary-service:hover\{transform:translateY\(-3px\);box-shadow:0 12px 26px rgba\(35,79,57,\.1\);background:#fff\}/)

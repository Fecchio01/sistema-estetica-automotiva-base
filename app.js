...
function renderDashboardOrganization() {
  ...
  const dashboardOrganizationModel = dashboardOrganization ? dashboardOrganization.buildDashboardOrganizationModel(services, serviceStates, globalThis.__teamProfiles || []) : null;

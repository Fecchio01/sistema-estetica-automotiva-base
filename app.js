...
function renderDashboardOrganization() {
  ...
  const checklistPendingMarkup = dashboardOrganizationModel ? dashboardOrganization.buildDashboardChecklistPendingMarkup(dashboardOrganizationModel) : '';
  ...
  if (checklistPendingMarkup) workspace.insertAdjacentHTML('beforeend', checklistPendingMarkup);

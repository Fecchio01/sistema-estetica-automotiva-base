...
function render(root) {
  ...
  root.querySelector('#quote-preview-cancel').addEventListener('click', () => { formHost.classList.add('hidden'); newButton.disabled = false; form.reset(); updateTotal() })
